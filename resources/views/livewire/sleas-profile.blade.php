            ...
            <table class="w-full mt-4 text-left table-auto min-w-max">
                ...
                <tbody>
                    ...
                    <x-profile-data
                        ...
                        :values="[
                            'name' => $sleas->name,
                            'nameWithInitials' => $sleas->nameWithInitials
                        ]"
                    ...
                    <x-profile-data
                        ...
                        :values="[
                            'Permenent Address' => [
                                $sleas->permAddressLine1,
                                $sleas->permAddressLine2,
                                $sleas->permAddressLine3,
                            ],
                            'Temporary Address' => [
                                $sleas->tempAddressLine1,
                                $sleas->tempAddressLine2,
                                $sleas->tempAddressLine3,
                            ],
                            'Mobile' => $sleas->mobile1,
                            'Whatsapp' => $sleas->mobile2,
                            'Email' => $sleas->email,
                        ]"
                    ...
                    <x-profile-data
                        ...
                        :values="[
                            'Race' => $sleas->race,
                            'Religion' => $sleas->religion,
                            'Civil Status' => $sleas->civilStatus,
                            'Birthday' => $sleas->birthDay,
                            'Gender' => $sleas->gender,
                        ]"
                    ...
                    <x-profile-data
                        ...
                        :values="[
                            'Education Division' => $sleas->educationDivision,
                            'GN Division' => $sleas->gnDivision,
                            'DS Division' => $sleas->dsDivision,
                            'District' => $sleas->district,
                            'Province' => $sleas->province,
                        ]"
