            ...
            <table class="w-full mt-4 text-left table-auto min-w-max">
                ...
                <tbody>
                    ...
                    <x-profile-data
                        ...
                        :params="['id' => $principal->cryptedId, 'category' => 'userName']"
                    ...
                    <x-profile-data
                        ...
                        link="principal.profileedit"
                        :params="['id' => $principal->cryptedId, 'category' => 'userContact']"
                        action="{{ $profileAction }}"
                    />
                    ...
                    <x-profile-data
                        ...
                        link="principal.profileedit"
                        :params="['id' => $principal->cryptedId, 'category' => 'userPersonal']"
                        action="{{ $profileAction }}"
                    />
                    ...
                    <x-profile-data
                        ...
                        link="principal.profileedit"
                        :params="['id' => $principal->cryptedId, 'category' => 'userLocation']"
                        action="{{ $profileAction }}"
                    />
                    ...
                    <x-profile-data
                        ...
                        link="principal.profileedit"
                        :params="['id' => $principal->cryptedId, 'category' => 'service']"
                        action="{{ $profileAction }}"
                    />
                    ...
                    <x-profile-data
                        ...
                        d="M11.7 2.3a1 1 0 011.6 0l9 7a1 1 0 01-.3 1.7l-9 3a1 1 0 01-.7 0l-9-3a1 1 0 01-.3-1.7l9-7zM12 5.2L5.2 10 12 12.8 18.8 10 12 5.2zM4 12.9a1 1 0 011.3-.6L12 15l6.7-2.7a1 1 0 111 .8L12 17l-7.7-3.1a1 1 0 01-.6-1zm16.7 3.3a1 1 0 00-1.4-.4l-5.3 3.2a3 3 0 01-3 0l-5.3-3.2a1 1 0 10-1 1.8l5.3 3.2a5 5 0 005 0l5.3-3.2a1 1 0 00.4-1.4z"
                        link="principal.profileedit"
                        :params="['id' => $principal->cryptedId, 'category' => 'userAppointment']"
                        action="{{ $profileAction }}"
                    />
                    ...
                    <x-profile-data
                        ...
                        d="M11.7 2.3a1 1 0 011.6 0l9 7a1 1 0 01-.3 1.7l-9 3a1 1 0 01-.7 0l-9-3a1 1 0 01-.3-1.7l9-7zM12 5.2L5.2 10 12 12.8 18.8 10 12 5.2zM4 12.9a1 1 0 011.3-.6L12 15l6.7-2.7a1 1 0 111 .8L12 17l-7.7-3.1a1 1 0 01-.6-1zm16.7 3.3a1 1 0 00-1.4-.4l-5.3 3.2a3 3 0 01-3 0l-5.3-3.2a1 1 0 10-1 1.8l5.3 3.2a5 5 0 005 0l5.3-3.2a1 1 0 00.4-1.4z"
                        link="principal.profileedit"
                        :params="['id' => $principal->cryptedId, 'category' => 'userRank']"
                        action="{{ $profileAction }}"
                    />
                    ...
                    <x-profile-data
                        ...
                        d="M11.7 2.3a1 1 0 011.6 0l9 7a1 1 0 01-.3 1.7l-9 3a1 1 0 01-.7 0l-9-3a1 1 0 01-.3-1.7l9-7zM12 5.2L5.2 10 12 12.8 18.8 10 12 5.2zM4 12.9a1 1 0 011.3-.6L12 15l6.7-2.7a1 1 0 111 .8L12 17l-7.7-3.1a1 1 0 01-.6-1zm16.7 3.3a1 1 0 00-1.4-.4l-5.3 3.2a3 3 0 01-3 0l-5.3-3.2a1 1 0 10-1 1.8l5.3 3.2a5 5 0 005 0l5.3-3.2a1 1 0 00.4-1.4z"
                        link="principal.profileedit"
                        :params="['id' => $principal->cryptedId, 'category' => 'userQualification']"
                        action="{{ $profileAction }}"
                    />
                    ...
                    <x-profile-data
                        ...
                        d="M11.7 2.3a1 1 0 011.6 0l9 7a1 1 0 01-.3 1.7l-9 3a1 1 0 01-.7 0l-9-3a1 1 0 01-.3-1.7l9-7zM12 5.2L5.2 10 12 12.8 18.8 10 12 5.2zM4 12.9a1 1 0 011.3-.6L12 15l6.7-2.7a1 1 0 111 .8L12 17l-7.7-3.1a1 1 0 01-.6-1zm16.7 3.3a1 1 0 00-1.4-.4l-5.3 3.2a3 3 0 01-3 0l-5.3-3.2a1 1 0 10-1 1.8l5.3 3.2a5 5 0 005 0l5.3-3.2a1 1 0 00.4-1.4z"
                        link="principal.profileedit"
                        :params="['id' => $principal->cryptedId, 'category' => 'userFamily']"
                        action="{{ $profileAction }}"
                    />
                    ...
                    <x-profile-data
                        heading="Login Info"
                        :values="[
                            'User Name' => $principal->nic,
                            'Password' => '******',
                        ]"
                        d="M11.7 2.3a1 1 0 011.6 0l9 7a1 1 0 01-.3 1.7l-9 3a1 1 0 01-.7 0l-9-3a1 1 0 01-.3-1.7l9-7zM12 5.2L5.2 10 12 12.8 18.8 10 12 5.2zM4 12.9a1 1 0 011.3-.6L12 15l6.7-2.7a1 1 0 111 .8L12 17l-7.7-3.1a1 1 0 01-.6-1zm16.7 3.3a1 1 0 00-1.4-.4l-5.3 3.2a3 3 0 01-3 0l-5.3-3.2a1 1 0 10-1 1.8l5.3 3.2a5 5 0 005 0l5.3-3.2a1 1 0 00.4-1.4z"
                        link="principal.profileedit"
                        :params="['id' => $principal->cryptedId, 'category' => 'userLogin']"
                        action="{{ $loginAction }}"
                    />
