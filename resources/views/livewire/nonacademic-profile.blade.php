                ...
                <tbody>
                    ...
                    <x-profile-data
                        ...
                        :values="[
                            ...
                            'nameWithInitials' => $nonacademic->nameWithInitials
                        ]"
                        ...
                        link="nonacademic.profileedit"
                        :params="['id' => $nonacademic->cryptedId, 'category' => 'userName']"
                    ...
                    <x-profile-data
                        ...
                        :values="[
                            'Permenent Address' => [
                                $nonacademic->permAddressLine1,
                                $nonacademic->permAddressLine2,
                                $nonacademic->permAddressLine3,
                            ],
                            'Temporary Address' => [
                                $nonacademic->tempAddressLine1,
                                $nonacademic->tempAddressLine2,
                                $nonacademic->tempAddressLine3,
                            ],
                            'Mobile' => $nonacademic->mobile1,
                            'Whatsapp' => $nonacademic->mobile2,
                        ...
                        link="nonacademic.profileedit"
                        :params="['id' => $nonacademic->cryptedId, 'category' => 'userContact']"
                        action="{{ $profileAction }}"
                    />
                    ...
                    <x-profile-data
                        ...
                        :values="[
                            'Race' => $nonacademic->race,
                            'Religion' => $nonacademic->religion,
                            'Civil Status' => $nonacademic->civilStatus,
                            'Birthday' => $nonacademic->birthDay,
                        ...
                        link="nonacademic.profileedit"
                        :params="['id' => $nonacademic->cryptedId, 'category' => 'userPersonal']"
                        action="{{ $profileAction }}"
                    />
                    ...
                    <x-profile-data
                        ...
                        :values="[
                            'Education Division' => $nonacademic->educationDivision,
                            'GN Division' => $nonacademic->gnDivision,
                            'DS Division' => $nonacademic->dsDivision,
                            'District' => $nonacademic->district,
                            'Province' => $nonacademic->province,
                        ]"
                        d="M12 2a7 7 0 00-7 7c0 5.25 7 13 7 13s7-7.75 7-13a7 7 0 00-7-7zm0 9.5a2.5 2.5 0 110-5 2.5 2.5 0 010 5z"
                        link="nonacademic.profileedit"
                        :params="['id' => $nonacademic->cryptedId, 'category' => 'userLocation']"
                        action="{{ $profileAction }}"
                    />
                    ...
                    <x-profile-data
                        ...
                        link="nonacademic.profileedit"
                        :params="['id' => $nonacademic->cryptedId, 'category' => 'service']"
                        action="{{ $profileAction }}"
                    />
                    ...
                    <x-profile-data
                        ...
                        d="M11.7 2.3a1 1 0 011.6 0l9 7a1 1 0 01-.3 1.7l-9 3a1 1 0 01-.7 0l-9-3a1 1 0 01-.3-1.7l9-7zM12 5.2L5.2 10 12 12.8 18.8 10 12 5.2zM4 12.9a1 1 0 011.3-.6L12 15l6.7-2.7a1 1 0 111 .8L12 17l-7.7-3.1a1 1 0 01-.6-1zm16.7 3.3a1 1 0 00-1.4-.4l-5.3 3.2a3 3 0 01-3 0l-5.3-3.2a1 1 0 10-1 1.8l5.3 3.2a5 5 0 005 0l5.3-3.2a1 1 0 00.4-1.4z"
                        link="nonacademic.profileedit"
                        :params="['id' => $nonacademic->cryptedId, 'category' => 'userAppointment']"
                        action="{{ $profileAction }}"
                    />
                    ...
                    <x-profile-data
                        ...
                        d="M11.7 2.3a1 1 0 011.6 0l9 7a1 1 0 01-.3 1.7l-9 3a1 1 0 01-.7 0l-9-3a1 1 0 01-.3-1.7l9-7zM12 5.2L5.2 10 12 12.8 18.8 10 12 5.2zM4 12.9a1 1 0 011.3-.6L12 15l6.7-2.7a1 1 0 111 .8L12 17l-7.7-3.1a1 1 0 01-.6-1zm16.7 3.3a1 1 0 00-1.4-.4l-5.3 3.2a3 3 0 01-3 0l-5.3-3.2a1 1 0 10-1 1.8l5.3 3.2a5 5 0 005 0l5.3-3.2a1 1 0 00.4-1.4z"
                        link="nonacademic.profileedit"
                        :params="['id' => $nonacademic->cryptedId, 'category' => 'userRank']"
                        action="{{ $profileAction }}"
                    />
                    ...
                    <x-profile-data
                        ...
                        d="M11.7 2.3a1 1 0 011.6 0l9 7a1 1 0 01-.3 1.7l-9 3a1 1 0 01-.7 0l-9-3a1 1 0 01-.3-1.7l9-7zM12 5.2L5.2 10 12 12.8 18.8 10 12 5.2zM4 12.9a1 1 0 011.3-.6L12 15l6.7-2.7a1 1 0 111 .8L12 17l-7.7-3.1a1 1 0 01-.6-1zm16.7 3.3a1 1 0 00-1.4-.4l-5.3 3.2a3 3 0 01-3 0l-5.3-3.2a1 1 0 10-1 1.8l5.3 3.2a5 5 0 005 0l5.3-3.2a1 1 0 00.4-1.4z"
                        link="nonacademic.profileedit"
                        :params="['id' => $nonacademic->cryptedId, 'category' => 'userQualification']"
                        action="{{ $profileAction }}"
                    />
                    ...
                    <x-profile-data
                        ...
                        d="M11.7 2.3a1 1 0 011.6 0l9 7a1 1 0 01-.3 1.7l-9 3a1 1 0 01-.7 0l-9-3a1 1 0 01-.3-1.7l9-7zM12 5.2L5.2 10 12 12.8 18.8 10 12 5.2zM4 12.9a1 1 0 011.3-.6L12 15l6.7-2.7a1 1 0 111 .8L12 17l-7.7-3.1a1 1 0 01-.6-1zm16.7 3.3a1 1 0 00-1.4-.4l-5.3 3.2a3 3 0 01-3 0l-5.3-3.2a1 1 0 10-1 1.8l5.3 3.2a5 5 0 005 0l5.3-3.2a1 1 0 00.4-1.4z"
                        link="nonacademic.profileedit"
                        :params="['id' => $nonacademic->cryptedId, 'category' => 'userFamily']"
                        action="{{ $profileAction }}"
                    />
                    ...
                    <x-profile-data
                        heading="Login Info"
                        :values="[
                            'User Name' => $nonacademic->nic,
                            'Password' => '******',
                        ]"
                        d="M11.7 2.3a1 1 0 011.6 0l9 7a1 1 0 01-.3 1.7l-9 3a1 1 0 01-.7 0l-9-3a1 1 0 01-.3-1.7l9-7zM12 5.2L5.2 10 12 12.8 18.8 10 12 5.2zM4 12.9a1 1 0 011.3-.6L12 15l6.7-2.7a1 1 0 111 .8L12 17l-7.7-3.1a1 1 0 01-.6-1zm16.7 3.3a1 1 0 00-1.4-.4l-5.3 3.2a3 3 0 01-3 0l-5.3-3.2a1 1 0 10-1 1.8l5.3 3.2a5 5 0 005 0l5.3-3.2a1 1 0 00.4-1.4z"
                        link="nonacademic.profileedit"
                        :params="['id' => $nonacademic->cryptedId, 'category' => 'userLogin']"
                        action="{{ $loginAction }}"
                    />
