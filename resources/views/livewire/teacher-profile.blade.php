            ...
            <table class="w-full mt-4 text-left table-auto min-w-max">
                ...
                <tbody>
                    ...
                    <x-profile-data
                        ...
                        :values="[
                            'Permenent Address' => [
                                $teacher->permAddressLine1,
                                $teacher->permAddressLine2,
                                $teacher->permAddressLine3,
                            ],
                            'Temporary Address' => [
                                $teacher->tempAddressLine1,
                                $teacher->tempAddressLine2,
                                $teacher->tempAddressLine3,
                            ],
                            'Mobile' => $teacher->mobile1,
                            'Whatsapp' => $teacher->mobile2,
                            'Email' => $teacher->email,
                        ]"
                    ...
                    <x-profile-data
                        ...
                        :values="[
                            ...
                            'Civil Status' => $teacher->civilStatus,
                    ...
                    <x-profile-data
                        ...
                        :values="[
                            'Education Division' => $teacher->educationDivision,
                            'GN Division' => $teacher->gnDivision,
                            'DS Division' => $teacher->dsDivision,
