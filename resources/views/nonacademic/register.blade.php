    ...
    <div class="py-3">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="isolate bg-white px-6 py-10 sm:py-10 lg:px-8">
                <x-form-heading heading="NON ACADEMIC REGISTRATION" subheading="Non Academic Registration Form" />
                <x-form-success message="{{ session('success') }}" />
                <form method="POST" action="{{ route('nonacademic.register') }}" class="mx-auto mt-8 max-w-xl sm:mt-8" enctype="multipart/form-data">
                    @csrf
