    ...
    <div class="py-3">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="isolate bg-white px-6 py-10 sm:py-10 lg:px-8">
                ...
                <form method="POST" action="{{ route('principal.profileupdate') }}" class="mx-auto mt-8 max-w-xl sm:mt-8" enctype="multipart/form-data">
                    @csrf
                        ...
                        @if($category == 'userQualification')
                            ...
                            <div x-data="{ showEduDelete: false }" class="sm:col-span-6 mt-6">
                                ...
                                <div x-show="showEduDelete" class="grid grid-cols-6 gap-6">
                                    <x-form-list-input-section size="sm:col-span-6" name="userEduQualification" id="userEduQualification" :options="$userEducationalQualifications" label="Principal Education Qualifications" />
                                </div>
                            </div>
                            ...
                            <div x-data="{ showProfDelete: false }" class="sm:col-span-6 mt-6">
                                ...
                                <div x-show="showProfDelete" class="grid grid-cols-6 gap-6">
                                    <x-form-list-input-section size="sm:col-span-6" name="userProfQualification" id="userProfQualification" :options="$userProfessionalQualifications" label="principal Professional Qualifications" />
                                </div>
                            </div>
                        @endif
                        ...
                        @if($category == 'userRank')
                            <div x-data="{ showAddRank: false, showDeleteRank: false }" class="sm:col-span-6">
                                ...
                                <div x-show="showDeleteRank" class="grid grid-cols-6 gap-6 mt-4">
                                    <x-form-list-input-section size="sm:col-span-6" name="userRank" id="userRank" :options="$userRanks" label="principal Rank History" />
                                </div>
                        ...
                        @if($category == 'userFamily')
                            ...
                            <div x-data="{ showAddFamily: false, showDeleteFamily: false }" class="sm:col-span-6">
                                ...
                                <div x-show="showDeleteFamily" class="grid grid-cols-6 gap-6 mt-4">
                                    <x-form-list-input-section size="sm:col-span-6" name="familyInfo" id="familyInfo" :options="$familyInfos" label="principal Family Information" />
                                </div>
