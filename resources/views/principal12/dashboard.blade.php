        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="p-1 px-0 overflow-scroll">
                <table class="w-full mt-4 text-left table-auto min-w-max">=
                    ...
                    <tbody>
                        @foreach ($principalCounts as $card)
                            <tr>
