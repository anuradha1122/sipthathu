...
class NonacademicSearch extends Component
{
    public $search = '';
    public $size;
    ...
    public function render()
    {
        ...
        if(strlen($this->search)>0){
            ...
            ->whereIn('user_in_services.serviceId', [9, 10, 11])
        ...
        return view('livewire.nonacademic-search', ['searchResults' => $searchResults]);
    }
}
